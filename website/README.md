...
Inherited Console Lite code is covered by the MIT notice in
`public/licenses/INHERITED-MIT.txt`. Roboto and Material Icons are listed in
`public/NOTICE.txt`, with the Apache License 2.0 in
