...
const DICT = {
  ...
  aboutApp: { zh: '关于 Console Neo', en: 'About Console Neo' },
  versionFmt: { zh: '版本 {v}', en: 'Version {v}' },
  hostVersionFmt: { zh: '主持设备：Console Neo v{v}', en: 'Host: Console Neo v{v}' },
  hostSourceFmt: { zh: '主持设备 v{v} 的源代码', en: 'Source for host v{v}' },
  sourceCode: { zh: '源代码', en: 'Source code' },
  licenseLine: { zh: '依 GNU AGPL v3 或更高版本授权，并附加额外条款。',
    en: 'Licensed under the GNU AGPL v3 or later, with additional terms.' },
  noWarranty: { zh: '本程序不提供任何担保。', en: 'This program comes with ABSOLUTELY NO WARRANTY.' },
  upstreamCredits: {
    zh: '包含 Console Lite（© 2016 Liu Xiaoyi）与 Console Lite Edited'
      + '（© 2018 Pan Ruizhe）的代码，依 MIT 许可使用。',
    en: 'Includes Console Lite (© 2016 Liu Xiaoyi) and Console Lite Edited'
      + ' (© 2018 Pan Ruizhe), under the MIT License.',
  },
  docLicense: { zh: '许可证（AGPL-3.0）', en: 'License (AGPL-3.0)' },
  docNotice: { zh: '声明与附加条款', en: 'Notice and additional terms' },
  docMit: { zh: '上游 MIT 许可', en: 'Upstream MIT License' },
  docThirdParty: { zh: '第三方声明', en: 'Third-party notices' },
  feedback: { zh: '反馈', en: 'Feedback' },
  partnerships: { zh: '商务合作', en: 'Partnerships' },
